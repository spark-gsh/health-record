    ...
    layui.use(['jquery', 'table'], function (exports) {
        ...
        table.render({
            ...
            cols: [[
                ...
                {
                    title: '所属疾病类别', width: 117, templet: function (d) {
                        return d.recordType.desc;
                    }
                },
                {field: 'name', title: '姓名', width: 81},
                ...
                {title: '回访', width: 91, toolbar: '#toolReturn '},
